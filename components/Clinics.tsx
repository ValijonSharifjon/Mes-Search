...
const Clinics = () => {
    return (
        <section className="max-container h-[424px] mt-[125px] flex flex-col gap-[38px]">
            <HeadingText title="Клиники" />
            <div className="flex gap-[41px]">
                {CLINICS.map((clinic) => (
                    <Link href={clinic.href} key={clinic.key}>
                        <div className="w-[270px] h-[270px] rounded-[15px] bg-[#ECF5FF] flex flex-col pl-[20px] pt-[15px]">
                            ...
                            <div>
                                <Link href='/' className="dodger-blue underline text-[11.688px] font-normal flex justify-center">Подробно</Link>
                            </div>
                        </div>
                    </Link>
                ))}
